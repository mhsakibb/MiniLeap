...
from OpenGL.GLUT import glutInit, glutInitDisplayMode, glutInitWindowSize, glutCreateWindow, glutDisplayFunc, glutKeyboardFunc, glutTimerFunc, glutMainLoop, glutBitmapCharacter, glutPostRedisplay, GLUT_SINGLE, GLUT_RGB, GLUT_BITMAP_HELVETICA_18
import random
import math
...
# =========================
def update(value):
    global cat_y, velocity_y, jumping
...
def keyboard(key, x, y):
    ...
    if key == ' ' and not jumping and not game_over:
        jumping = True
...
def restart():
    global game_over, score, cat_y, jumping, velocity_y
